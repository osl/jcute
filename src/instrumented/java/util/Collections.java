...
public class Collections {
    ...
    public List subList(int fromIndex, int toIndex) {
        ...
        private Object readResolve() {
            if (list instanceof RandomAccess) return new UnmodifiableRandomAccessList(list);
            else return this;
        }
    }
    ...
    public static List synchronizedList(List list) {
        if (list instanceof RandomAccess) return new SynchronizedRandomAccessList(list);
        else return new SynchronizedList(list);
    }

    static List synchronizedList(List list, Object mutex) {
        if (list instanceof RandomAccess) return new SynchronizedRandomAccessList(list, mutex);
        else return new SynchronizedList(list, mutex);
    }
